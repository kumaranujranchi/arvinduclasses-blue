  ...
  return (
    <div className="admin-wrapper flex h-screen bg-[#f4f7fb] overflow-hidden font-sans text-slate-900">
      ...
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-full z-50">
        ...
        <div className="p-4 border-t border-gray-50">
          <button 
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 text-[#64748b] hover:text-red-500 hover:bg-red-50 rounded-xl transition-all group"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* We removed the top bar as requested */}
