        ...
        <div className="page-banner-bg bg_cover page-banner-bg-image">
          <div className="container">
            <div className="banner-content text-center wow fadeInDown course-detail-banner-content">
              ...
              <div className="banner-divider-purple"></div>
              ...
              <div className="courses-details-content">
                ...
                <div className="overview-section mt-50 wow fadeInUp">
                  ...
                  <ul className="courses-details-list mt-10px">
                    <li className="course-list-item"><i className="fas fa-check" className="list-icon-purple-t4"></i> <p className="course-list-text">Understand concepts clearly</p></li>
                    <li className="course-list-item"><i className="fas fa-check" className="list-icon-purple-t4"></i> <p className="course-list-text">Prepare effectively for semester exams</p></li>
                    <li className="course-list-item"><i className="fas fa-check" className="list-icon-purple-t4"></i> <p className="course-list-text">Improve answer presentation and writing skills</p></li>
                    <li className="course-list-item"><i className="fas fa-check" className="list-icon-purple-t4"></i> <p className="course-list-text">Strengthen their academic foundation for future careers</p></li>
                  </ul>
                ...
                <div className="row mt-40">
                  <div className="col-md-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <div className="highlight-card" className="card-highlight-purple">
                       <h5 className="course-highlight-title">Semester Ready</h5>
                       <p className="fs-14-gray">Structured preparation for semester exams with a focus on university-specific paper patterns.</p>
                    </div>
                  </div>
                  <div className="col-md-6 wow fadeInRight" data-wow-delay="0.1s">
                    <div className="highlight-card course-highlight-card-dark">
                       ...
                       <p className="fs-14-gray">Special focus on improving answer presentation and writing techniques for higher scores.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="courses-details-tab wow fadeInUp course-tab-container">
                  ...
                  <div className="tab-content course-tab-content-wrapper">
                    ...
                    {activeTab === 'reviews' && (
                      <div className="tab-pane fade show active">
                        <div className="review-card-purple">
                           <p className="course-review-text">“This program helped me understand my B.Com subjects much better. The guidance and regular support made exams much easier.”</p>
                           <p className="course-review-author">— B.Com Student</p>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div className="courses-sidebar sticky-top-100">
                ...
                <div className="courses-features wow fadeInRight course-sidebar-widget-v2">
                  ...
                  <ul className="courses-features-items m-0 p-0">
                    <li className="course-sidebar-item-border">Fee <strong>₹45,000</strong></li>
                    <li className="course-sidebar-item-border">Duration <strong>3 Years</strong></li>
                    <li className="course-sidebar-item-border">Classes <strong>4–5 Days/Week</strong></li>
                    <li className="course-sidebar-item-border">Mode <strong>University Support</strong></li>
                    <li className="course-sidebar-item-border">Exams <strong>Semester-wise</strong></li>
                    <li className="course-sidebar-item-border">Revision <strong>Session Support</strong></li>
            ...
            <div className="row align-items-center" className="relative-z2">
              <div className="col-lg-8 text-center text-lg-left">
                <div className="cta-text-wrapper">
                  <h2 className="title" className="course-cta-title">Get the Right Guidance for Your Graduation</h2>
                  <p className="course-cta-desc">Strengthen your concepts and perform better in your B.Com exams with expert support.</p>
                </div>
              </div>
