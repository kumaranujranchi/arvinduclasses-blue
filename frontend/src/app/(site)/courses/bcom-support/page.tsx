              ...
              <div className="courses-details-content">
                ...
                <div className="overview-section mt-50 wow fadeInUp">
                  ...
                  <ul className="courses-details-list mt-10px">
                    <li className="course-list-item"><i className="fas fa-check list-icon-purple-t4"></i> <p className="course-list-text">Understand concepts clearly</p></li>
                    <li className="course-list-item"><i className="fas fa-check list-icon-purple-t4"></i> <p className="course-list-text">Prepare effectively for semester exams</p></li>
                    <li className="course-list-item"><i className="fas fa-check list-icon-purple-t4"></i> <p className="course-list-text">Improve answer presentation and writing skills</p></li>
                    <li className="course-list-item"><i className="fas fa-check list-icon-purple-t4"></i> <p className="course-list-text">Strengthen their academic foundation for future careers</p></li>
                  </ul>
                ...
                <div className="row mt-40">
                  <div className="col-md-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <div className="highlight-card card-highlight-purple">
            ...
            <div className="row align-items-center relative-z2">
              <div className="col-lg-8 text-center text-lg-left">
                <div className="cta-text-wrapper">
                  <h2 className="title course-cta-title">Get the Right Guidance for Your Graduation</h2>
