        ...
        <div className="page-banner-bg bg_cover" style={{ backgroundImage: "url(/assets/images/course-banner.png)", padding: "100px 0" }}>
          <div className="container">
            <div className="banner-content text-center wow fadeInDown">
              <h2 className="title" style={{ fontSize: "36px", fontWeight: "800", color: "#fff", textShadow: "0 2px 4px rgba(0,0,0,0.3)" }}>Physics, Chemistry & Biology</h2>
              <div style={{ width: "60px", height: "4px", background: "#2F7AD5", margin: "20px auto" }}></div>
              <p style={{ color: "#fff", fontSize: "18px", fontWeight: "500" }}>Mastering Science through conceptual clarity and regular practice.</p>
            </div>
          </div>
        </div>
      </section>
